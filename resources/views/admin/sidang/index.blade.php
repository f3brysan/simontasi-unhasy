                                            ...
                                            <div class="card-body p-3 d-flex align-items-center">
                                                ...
                                                <div>
                                                    <div class="fs-6 fw-semibold text-primary">
                                                        {{ count($getDataProposals) }} Tugas Akhir / Tesis / Munasaqoh</div>
                                    ...
                                    <div class="col-6 col-lg-3">
                                        <div class="card">
                                            <div class="card-body p-3 d-flex align-items-center">
                                                ...
                                                <div>
                                                    <div class="fs-6 fw-semibold text-primary">
                                                        {{ count($getWaitProposals) }} Tugas Akhir / Tesis / Munasaqoh</div>
                                                    <div class="text-medium-emphasis text-uppercase fw-semibold small">
                                    ...
                                    <div class="col-6 col-lg-3">
                                        <div class="card">
                                            <div class="card-body p-3 d-flex align-items-center">
                                                ...
                                                <div>
                                                    <div class="fs-6 fw-semibold text-primary">
                                                        {{ count($getDoneProposals) }} Tugas Akhir / Tesis / Munasaqoh</div>
                                                    <div class="text-medium-emphasis text-uppercase fw-semibold small">
                                        ...
                                        <table class="table table-sm table-bordered table-striped" id="myTable">
                                            <thead>
                                                <tr>
                                                    ...
                                                    <th class="text-center">Judul Tugas Akhir / Tesis / Munasaqoh</th>
    ...
    <script>
        $(document).ready(function() {
            ...
            $(document).on("click", ".approve", function() {
                ...
                Swal.fire({
                    title: "Perhatian",
                    text:  msg+ " pendaftaran Tugas Akhir / Tesis / Munasaqoh " + nim + " - " + name + "?",
                    icon: "warning",
                    ...
                    if (result.isConfirmed) {
                        $.get("{{ URL::to('proposal/approve/') }}/" + id,
                            function(data) {
                                ...
                                iziToast.success({
                                    title: 'Berhasil',
                                    message: 'Tugas Akhir / Tesis / Munasaqoh berhasil ' + msg + '.',
                                    position: 'topRight'
                                });
                            });
                    }
