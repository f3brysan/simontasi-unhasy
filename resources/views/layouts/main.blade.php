      ...
      <body>
       @include('layouts.navbar')
        <div class="wrapper d-flex flex-column min-vh-100 bg-light">
          ...
          <footer class="footer">
            <div><a href="{{ URL::to('/') }}/https://coreui.io">CoreUI </a><a href="{{ URL::to('/') }}/https://coreui.io">Bootstrap Admin Template</a> © 2023 creativeLabs.</div>
            <div class="ms-auto">Powered by&nbsp;<a href="{{ URL::to('/') }}/https://coreui.io/docs/">CoreUI UI Components</a></div>
          </footer>
        </div>
