    ...
    <div class="container-fluid">
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb my-0 ms-2">
                <li class="breadcrumb-item active"><span>Sidang {{ $dataSidang->type == 'P' ? 'Proposal' : 'Akhir/TESIS/MUNAQOSAH' }} </span></li>
            </ol>
        </nav>
    </div>
@endsection
        ...
        <div class="container-lg">
            ...
            <div class="card mb-4">
                <div class="card-header">
                    <h5>Sidang {{ $dataSidang->type == 'P' ? 'Proposal' : 'Akhir/TESIS/MUNAQOSAH' }} </h5></span>
                </div>
                <div class="card-body">
                    @if (!empty($dataSidang))
                        <div class="table container-fluid">
                            <table class="table table-bordered table-hover">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="row">
                                            <div class="col-md-10">{!! $dataSidang->title !!}</div>                                            
                                        </div>
                                    </td>
                                </tr>
                                <tr>
...
@push('js')
    ...
    <script>
        ...
        function countLogBook() {
            $.ajax({
                type: "GET",
                url: "{{ URL::to('log-book/count/' . Crypt::encrypt($dataSidang->id ?? '')) }}",
    ...
    <script>
        table = $('#myTable').DataTable({
            ...
            serverSide: true,
            ajax: {
                url: "{{ URL::to('log-book/get/' . Crypt::encrypt($dataSidang->id ?? '')) }}",
                type: 'GET'
            },
            columns: [{
                    data: 'action',
